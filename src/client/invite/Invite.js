  ...
  render() {
    ...
    return (
      <div className="shifted">
        <Helmet>
          <title>{intl.formatMessage({ id: 'invite', defaultMessage: 'Invite' })} - STEEMGroups</title>
        </Helmet>
          ...
          <div className="center">
            <div className="Invite">
              ...
              <h1 className="Invite__title">
                <FormattedMessage id="invite_title" defaultMessage="Don't use STEEMGroups alone!" />
              </h1>
              ...
              <div className="Invite__social">
                ...
                <TwitterShare
                  ...
                  text={intl.formatMessage(
                    {
                      id: 'invite_share',
                      defaultMessage: 'Join me today on STEEMGroups.com and get rewarded to post items for sale {link}',
                    },
                    {
                      link: '',
                    },
                ...
                <EmailShare
                  ...
                  text={intl.formatMessage(
                    {
                      id: 'invite_share',
                      defaultMessage: 'Join me today on STEEMGroups.com and get rewarded to post for sale {link}',
                    },
                    {
